...
<body class="AcceuilPages">
    ...
    <main>
        ...
        <p class="welcomeDiscord">Bienvenue sur discord ! Connectez vous pour accéder au <a
                href="./users/formLogin.php"> salon</a></p>
        <div class="paragInsc">
            <p class="welcomeDiscord">Vous n'avez pas de compte ? Vous pouvez vous inscrire <a
                    href="./users/formRegister.php"> Maitnenant</a></p>
        </div>
